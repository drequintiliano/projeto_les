...
function render(input, out, __component, component, state) {
  ...
  marko_forOf(data.servicos, function(servico) {
    ...
    out.w("<div" +
      ...
      " tabindex=-1 aria-labelledby=exampleModalLabel aria-hidden=true><div class=modal-dialog><div class=modal-content><div class=modal-header><h5 class=modal-title id=exampleModalLabel>Solicitar - " +
      marko_escapeXml(servico.titulo) +
