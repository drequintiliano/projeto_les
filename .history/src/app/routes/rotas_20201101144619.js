...
routes.get('/cadastrar_profissional', function(req, res) {
    res.sendFile(path.resolve(__dirname + '../../views/cadastro/cadastrar_profissional.marko'));
});
...
routes.post('/cadastrar_profissional', usuarioProfissionalController.cadastrarCliente());
