...
/*------------------------------ Rotas Solicitações Profissional ------------------------------*/

routes.get('/solicitacao_profissional', function(req, resp) {

    const solicitacoesProfissional = new SolicitacoesProfissional(db);
    solicitacoesProfissional.listarTodos()
        .then(solicitacoes => resp.send(
            require('../views/perfil/profissional/perfil_profissional_solicitacoes.html'), {
